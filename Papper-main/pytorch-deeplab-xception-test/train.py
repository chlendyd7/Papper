...
class Trainer(object):
    def __init__(self, args):
        ...
        self.train_loader, self.val_loader, self.test_loader, self.train_ids, self.val_ids, self.test_ids, self.nclass = make_data_loader(args)#설정된 Dataset의 값을 가져온다
    ...
    def training(self, epoch):
        train_loss = 0.0
        self.model.train()
        tbar = tqdm(self.train_loader)#프로그램 모듈
